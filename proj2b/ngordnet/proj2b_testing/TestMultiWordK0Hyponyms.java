...
public class TestMultiWordK0Hyponyms {
    ...
    @Test
    public void test1AlterationAndTransitionK0() {
        NgordnetQueryHandler studentHandler = AutograderBuddy.getHyponymHandler(
                WORDS_FILE, TOTAL_COUNTS_FILE, SMALL_SYNSET_FILE, SMALL_HYPONYM_FILE);
        List<String> words = List.of("alteration", "transition");
    ...
    public void testVideoAndRecordingK0() {
        ...
        List<String> words = List.of("video", "video_recording");
    ...
    @Test
    public void test4PastryAndTartK0() {
        NgordnetQueryHandler studentHandler = AutograderBuddy.getHyponymHandler(
                WORDS_FILE, TOTAL_COUNTS_FILE, LARGE_SYNSET_FILE, LARGE_HYPONYM_FILE);
